...
pub struct ElementWiseAddPipeline {
    pipeline: wgpu::ComputePipeline,
    backend: Arc<GpuBackend>,
}

impl ElementWiseAddPipeline {
    pub fn new_pipeline(backend: Arc<GpuBackend>) -> Self {
        let shader = backend
            .device
            .create_shader_module(wgpu::include_wgsl!("../element_wise_add.wgsl"));
    ...
    pub async fn compute(
        ...
        self.compute_timestamp(input1, input2, None, shape).await
    }
    ...
    pub async fn compute_timestamp(
        ...
        let bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry {
                    binding: 1,
                    resource: input2.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 2,
